...
namespace JuanJoseAraujoTaller2MVC.Controllers
{
    public class PromosController : Controller
    {
        ...
        public PromosController(JuanJoseAraujoTaller2MVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Promo != null ? 
                          ...
                          Problem("Entity set 'JuanJoseAraujoTaller2MVCContext.Promo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JuanJoseAraujoTaller2MVCContext.Promo'  is null.");
            }
            var promo = await _context.Promo.FindAsync(id);
            if (promo != null)
            {
