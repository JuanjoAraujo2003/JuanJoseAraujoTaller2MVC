...
namespace JuanJoseAraujoTaller2MVC.Controllers
{
    public class BurgersController : Controller
    {
        private readonly JuanJoseAraujoTaller2MVCContext _context;

        public BurgersController(JuanJoseAraujoTaller2MVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'JuanJoseAraujoTaller2MVCContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JuanJoseAraujoTaller2MVCContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
